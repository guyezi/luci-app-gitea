...
module("luci.model.cbi.gitea.api", package.seeall)
...
function to_download(url)
    ...
    sys.call("/bin/rm -f /tmp/gitea_download.*")

    local tmp_file = util.trim(util.exec(
                                   "mktemp -u -t gitea_download.XXXXXX"))
...
function to_extract(file, subfix)
    ...
    sys.call("/bin/rm -rf /tmp/gitea_extract.*")
